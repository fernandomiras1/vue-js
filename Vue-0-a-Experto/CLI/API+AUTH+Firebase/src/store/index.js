...
export default createStore({
  ...
  actions: {
    ...
    async ingresoUsuario({ commit }, usuario) {
      try {
        ...
        // Se loga y lo mandamos a la pagina de home
        router.push('/')
        // Lo guardamos en localStorage los datos del usuario.
  ...
  // getters: Nos sirver para Retornar informar del state y utilizar en nuestras vistas.
  // Se una en el Navbar.vue
  getters: {
    usuarioAutenticado(state) {
      // doble esclamacion nos va a devoler un false o un true. direcamente. ( si es null no va a devolver un false )
      return !!state.user
    }
  },
  modules: {
